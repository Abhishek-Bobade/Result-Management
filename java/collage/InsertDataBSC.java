...
@WebServlet("/insertbsc")
public class InsertDataBSC extends GenericServlet implements Servlet {
	...
	public void service(ServletRequest request, ServletResponse response) throws ServletException, IOException {
		try {
			PreparedStatement pstm = con.prepareStatement("insert into BSC_STUDENT values(?,?,?,?,?,?,?,?,?,?)");
			...
			if(x>0) {
				...
				RequestDispatcher rd = request.getRequestDispatcher("Insert_BSC.html");
