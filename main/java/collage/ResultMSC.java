...
public class ResultMSC extends GenericServlet {
	public void service(ServletRequest req, ServletResponse res) throws ServletException, IOException {
		try {
			...
			PreparedStatement pstm = con.prepareStatement(DataBase.getMSC_STUDENT());
			...
			pw.println("<center><h1>" + "Student Details of MSC" + "</h1><h1 style=color:white;>Dashboard</h1></center><hr><br>");
			...
			pw.println("<td> Computer Network </td>");
			pw.println("<td> Database Operation </td>");
			pw.println("<td> Data Structure </td>");
